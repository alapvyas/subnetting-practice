...
def main():
    print("Welcome to IPv4 Subnetting Practice!")
    print("You will have one minute to answer each question.")
    print("Press Enter to start the first question.")
    input()

    correct_answers = 0
    total_questions = 5  # You can change this to the number of questions you want to practice.
    total_time = 0
    ...
    for _ in range(total_questions):
        ...
        if (user_answer_network == str(subnet.network_address) and
